    ...
    it("should return the top 10 imports", async () => {
      ...
      chai.expect(
        stdOutWriteStub
          .getCall(2)
          .calledWith(
            "ID                       start date               finish date              status  author\n"
          )
      ).to.be.true;
      chai.expect(
        stdOutWriteStub
          .getCall(3)
          .calledWith(
            "a243b3a44fa243b3a44f3a55 2019-12-29T16:15:01.338Z                          RUNNING testeuser\n"
          )
      ).to.be.true;
      chai.expect(
        stdOutWriteStub
          .getCall(4)
          .calledWith(
            "f243b5a44fa2c3b5a43f3a56 2019-12-30T15:10:06.018Z 2019-12-30T15:13:06.031Z SUCCESS testeuser\n"
          )
      ).to.be.true;
    });
  });
